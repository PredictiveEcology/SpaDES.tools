...
test_dir("C:/Users/Tati/Documents/GitHub/repex/cropRepLCC05-prepInputs/prepInputsProblems/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/Tati/Documents/GitHub/repex/cropRepLCC05-prepInputs/prepInputsProblems/tests/testthat/test-template.R")
